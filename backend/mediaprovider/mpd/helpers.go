...
func findAlbumTracks(conn *mpd.Client, albumName, artistName string) ([]mpd.Attrs, error) {
	if artistName != "" {
		...
		return conn.Find("album", albumName, "artist", artistName)
	}
	return conn.Find("album", albumName)
}
