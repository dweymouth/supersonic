...
##Debian 11 fix?
cp /usr/lib/x86_64-linux-gnu/libc.so.6 Supersonic.AppDir/usr/lib/ #???
##Denoam 11 fix end

#cp /usr/lib64/ld-linux-x86-64.so.2 Supersonic.AppDir/usr/lib #
####GLX FIX?
cp /usr/lib/x86_64-linux-gnu/libGL.so.1 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libGLX.so.0 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libGLX.so.0.0.0 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libGLdispatch.so.0 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libX11.so.6 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXext.so.6 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXrender.so.1 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libsndio.so.7 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libquadmath.so.0 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXdamage.so.1 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXrender.so.1 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXfixes.so.3 Supersonic.AppDir/usr/lib
cp /usr/lib/x86_64-linux-gnu/libXxf86vm.so.1 Supersonic.AppDir/usr/lib
###GLX FIX? end
